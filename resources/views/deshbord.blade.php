...
<style>
    body {
      padding: 25px;
      background-color: rgb(242, 231, 236);
      color: rgb(31, 29, 29);
      font-size: 15px;
      /* text-align: right; */
    }
...
<div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-4 text-center small">
                        ...
                        <span class="mr-2">
                            <i class="fas fa-circle text-info"></i> Room
                        </span>
                        <span class="mr-2">
                            <i class="fas fa-circle text-warning"></i> Staff
                        </span>
                    </div>
                </div>
            </div>
 ...
 <script type="text/javascript">
    var _labels={!! json_encode($_labels)!!};
    var _data={!! json_encode($_data)!!};
</script>
