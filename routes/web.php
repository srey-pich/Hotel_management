...
Route::get('/service',[Homecontroller::class, 'Service_detail']);
...
//AdminDashborad
Route::get('admin/login', [AdminController::class, 'dashbord']);
//admin login
...
Route::get('/add-testimonial',[HomeController::class,'add_testimonial']);
